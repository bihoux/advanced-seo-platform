...
export const Route = createFileRoute("/cours/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sélectionnez un module du cours universitaire SEO Avancé 2026 : architecture technique, stratégie de contenu, données structurées, hreflang & performance." },
      ...
      { property: "og:url", content: "https://redaction-et-optimisation-seo-avancee.netlify.app/cours" },
    ],
    links: [{ rel: "canonical", href: "https://redaction-et-optimisation-seo-avancee.netlify.app/cours" }],
  }),
